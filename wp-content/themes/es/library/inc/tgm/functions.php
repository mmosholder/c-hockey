 ...
 */
require_once get_template_directory() . '/library/inc/tgm/class-tgm-plugin-activation.php';
...
function es_register_required_plugins() {
  ...
  //    	),
   ...
   //   	),
		...
		// array(
		// 	'name'      => 'WP Clear File Cache',
		// 	'slug'      => 'wp-clear-file-cache',
  //     		'source'    => get_template_directory() . '/library/plugins/wp-clear-file-cache.zip',
		// 	'required'  => true,
  //   	),
	);
